<?php if(isset($page) && isset($ml)): ?>
	<!-- Blazed Labs LLC Common Organization Schema -->
		<?php echo Layout_Main::do_schema(Layout_Main::do_kit()); ?>
	<!-- Meta tags -->
		<!-- General -->
		<?php
			$c = \Config::get('misc.company_name');
			$pt = Layout_Main::do_title($page);
			$pd = \Config::get('misc.site_name') . ' - ' . $pt;
		?>
		<!-- 1. Essential -->
		<?php if($ml >= 1): ?>
			<meta charset="utf-8">
		...
		<?php if($ml >= 2): ?>
			...
			<meta itemprop="name" content="<?php echo \Config::get('misc.site_name'); ?>">
			<meta itemprop="description" content="<?php echo $pd; ?>">
			<meta itemprop="image" content="<?php echo \Config::get('misc.site_logo'); ?>">
		<?php endif; ?>
		<!-- 3. Mobile -->
		<?php if($ml >= 3): ?>
			<!-- 3.1. Android  -->
			<meta name="theme-color" content="<?php echo \Config::get('misc.site_color'); ?>">
			<meta name="mobile-web-app-capable" content="yes">
			<!-- 3.2. iOS -->
			<meta name="apple-mobile-web-app-title" content="<?php echo \Config::get('misc.site_name'); ?>">
			...
			<meta name="application-name" content="<?php echo \Config::get('misc.site_name'); ?>">
		...
		<?php if($ml >= 4): ?>
			...
			<meta property="og:image" content="<?php echo \Config::get('misc.site_logo'); ?>">
			<meta property="og:image:alt" content="<?php echo $c; ?> Logo.">
			<meta property="og:description" content="<?php echo $pd; ?>">
			<meta property="og:site_name" content="<?php echo \Config::get('misc.site_name'); ?>">
			...
			<meta name="twitter:title" content="<?php echo \Config::get('misc.site_name'); ?>">
			<meta name="twitter:description" content="<?php echo $pd; ?>">
			<meta name="twitter:image" content="<?php echo \Config::get('misc.site_logo'); ?>">
